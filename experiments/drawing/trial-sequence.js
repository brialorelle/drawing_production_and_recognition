...
function restartExperiment() {
   ...
   current_data = {
    ...
    window.location.href="http://stanford-cogsci.org:8880/landing_page.html" // load back to regular landing page
}
...
window.onload = function() {
    ...
    function refresh() {
        if (new Date().getTime() - time >= refreshTime) {
                window.location.href="http://stanford-cogsci.org:8880/index.html"
