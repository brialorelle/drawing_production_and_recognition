...
ggsave('figures_out/figure5b_distinct_by_age.pdf', height=3,  units='in')

write_csv(distinct_by_age, file = here::here('data/figures_csvs/figure5b_distinct_by_age.csv'))
```
...
ggsave('figures_out/appendix_producer_by_recognizer_age.pdf',units='in', width=4, height=3)
...
ggsave('figures_out/appendix_recognition_by_category.pdf', units='in', width=7.5)
```
