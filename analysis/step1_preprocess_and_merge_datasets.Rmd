...
We found that tracing scores produced by the same participant were moderately correlated ($r$ = .60, $t$ = 61.93, $df$ = 6754, $p$ < .001, \textit{N} = `r length(unique(tracing_correlation$session_id))`), despite the irregular shape being harder to trace than the square.
